                ...
                <div class="col-md-5">
                    <div class="form">
                        <form method="post" action="{{ route('register.store') }}">
                            ...
                            <div class="mb-3">
                                <label for="namaInput" class="form-label">Name</label>
                            ...
                            <div class="mb-3">
                                <label for="alamatInput" class="form-label">Address</label>
                            ...
                            <div class="mb-3">
                                <label for="passwordInput_confirmation" class="form-label">Confirm Password</label>
